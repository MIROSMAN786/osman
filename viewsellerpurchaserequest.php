...
else
{
	 if($rs[7] == "Pending")
	{
	echo "<a href='viewpurchaseorderbill.php?purchaserequestid=$rs[0]' class='btn btn-info' style='width: 100%'>Send Quotation</a>";
	}
	else
	{
...
{
echo "<a href='viewsellerpurchaserequest.php?deleteid=$rs[0]' onclick='return delconfirm()' class='btn btn-danger' style='width: 100%' >Delete</a>";
}				 							 
echo "</td></tr>";
}
							  ?>
